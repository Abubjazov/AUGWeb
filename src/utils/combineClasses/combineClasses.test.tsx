...
describe('combineClasses', () => {
  test('combineClasses(): should return "string" from 1 items', () => {
  ...
  test('combineClasses(): should return "string" from 2 items', () => {
    expect(combineClasses(['class-1', 'class-2'])).toBe('class-1 class-2')
  })

  test('combineClasses(): should return "string" from 3 items', () => {
